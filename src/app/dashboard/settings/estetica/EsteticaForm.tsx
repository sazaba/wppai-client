      ...
      >
        <div className="flex items-center justify-between gap-4 p-4 rounded-2xl bg-white/[.03] border border-white/10">
          <div className="min-w-0">
            ...
            <div className="text-[12px] text-slate-400">
              Si está activo, la IA solo creará la cita cuando el cliente confirme explícitamente.
            </div>
          </div>

          <Toggle
  checked={!!value.requireClientConfirmation}
  onClick={() =>
    patch("requireClientConfirmation", !value.requireClientConfirmation)
  }
  sr="Alternar confirmación del cliente"
/>
