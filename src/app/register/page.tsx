...
export default function RegisterPage() {
  ...
  // 🎉 Dispara confeti multicolor en varias direcciones
  useEffect(() => {
    if (showModal) {
      ...
      const frame = () => {
        confetti({
          ...
          spread: 55,
          origin: { x: 0 },
          colors: ['#4F46E5', '#22D3EE', '#F59E0B', '#EF4444']
        })
        confetti({
          particleCount: 5,
          angle: 120,
          spread: 55,
          origin: { x: 1 },
          colors: ['#4F46E5', '#22D3EE', '#F59E0B', '#10B981']
        })
        confetti({
          particleCount: 4,
          spread: 360,
          origin: { x: 0.5, y: 0 },
          colors: ['#6366F1', '#F472B6', '#FB923C', '#84CC16']
        })
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Intentar cargar la empresa recién creada (sin bloquear si falla)
      try {
        ...
        console.error('[RegisterPage] Error cargando empresa:', empresaErr.response?.data || empresaErr.message)
      }
      ...
      console.error('[RegisterPage] Error en registro:', err)
              ...
              >
                <Dialog.Panel className="mx-auto max-w-md rounded-2xl bg-white p-6 shadow-xl text-center">
                  ...
                  <motion.ul
                    ...
                    className="text-left text-gray-600 mb-6 list-disc list-inside space-y-1"
                  >
